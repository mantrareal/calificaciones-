-- SISTEMA CORRECTO: Empleados precargados + Registro real
...
-- PASO 2: Crear tabla de empleados disponibles (sin emails)
...
-- PASO 3: Modificar tabla users para referencias
DROP TABLE IF EXISTS users CASCADE;
CREATE TABLE users (
  id TEXT PRIMARY KEY,
  email TEXT UNIQUE NOT NULL,
  password_hash TEXT, -- Para cuando implementes auth real
...
-- PASO 7: Insertar TODOS los CLOSERS disponibles
...
('avail_68668', '68668', 'VICTOR MANUEL', 'ACUÑA DIAZ', 'closer', 'BILL'),
...
-- PASO 10: Verificar empleados disponibles
